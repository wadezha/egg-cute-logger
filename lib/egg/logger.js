...
const RedisTransport = require('../transports/redis');
const AmqpTransport = require('../transports/amqp');

module.exports = app => {

  if (app.config.cuteLogger.transports.include('redis')) {
  ...
  if (app.config.cuteLogger.transports.include('amqp')) {
